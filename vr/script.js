...
$(document).ready(function() {
	...
	if(ids === null) {
		...
		data = 	'<VolumeData dimensions="2.452381 1.46667 1">' +
					...
					'<ShadedVolumeStyle lighting="false" baseColor="1 1 1" contrast="0.8" brightness="0"><Material></Material></ShadedVolumeStyle>' +
				'</VolumeData>';
	} else {
		data = '';
	...
	if(regions !== null) {
		for(var i = 0; i < regions.length; i++) {
			...
			regionsText += 	'<VolumeData dimensions="2.452381 1.46667 1">' +
...
function fullscreen() {
	...
	// Hiding fullscreen button and compatibility message when entering fullscreen
	$('#full-btn, #compat-message').css('display', 'none');
}
